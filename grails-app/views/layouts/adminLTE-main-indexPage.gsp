            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <a href="#" class="dropdown-item">
                        <!-- Message Start -->
                        <div class="media">
                            <asset:image src="/${session.getAttribute('themeVariation')}/dist/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle"/>
                    ...
                    <a href="#" class="dropdown-item">
                        <!-- Message Start -->
                        <div class="media">
                            <asset:image src="/${session.getAttribute('themeVariation')}/dist/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3"/>
                            <div class="media-body">
                                <h3 class="dropdown-item-title">
                                    John Pierce
                    ...
                    <a href="#" class="dropdown-item">
                        <!-- Message Start -->
                        <div class="media">
                            <asset:image src="/${session.getAttribute('themeVariation')}/dist/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3"/>
                            <div class="media-body">
                                <h3 class="dropdown-item-title">
                                    Nora Silvester
                            ...
                            <div class="card-body">
                                ...
                                <div class="direct-chat-messages">
                                    ...
                                    <div class="direct-chat-msg">
                                        ...
                                        <!-- /.direct-chat-infos -->
                                        <asset:image class="direct-chat-img" src="/${session.getAttribute('themeVariation')}/dist/img/user1-128x128.jpg" alt="message user image"/>
                                        <!-- /.direct-chat-img -->
                                    ...
                                    <div class="direct-chat-msg right">
                                        ...
                                        <!-- /.direct-chat-infos -->
                                        <asset:image class="direct-chat-img" src="/${session.getAttribute('themeVariation')}/dist/img/user3-128x128.jpg" alt="message user image"/>
                                        <!-- /.direct-chat-img -->
                                        <div class="direct-chat-text">
                                ...
                                <div class="direct-chat-contacts">
                                    <ul class="contacts-list">
                                        <li>
                                            <a href="#">
                                                <asset:image class="contacts-list-img" src="/${session.getAttribute('themeVariation')}/dist/img/user1-128x128.jpg"/>
                                        ...
                                        <li>
                                            <a href="#">
                                                <asset:image class="contacts-list-img" src="/${session.getAttribute('themeVariation')}/dist/img/user7-128x128.jpg"/>
                                        ...
                                        <li>
                                            <a href="#">
                                                <asset:image class="contacts-list-img" src="/${session.getAttribute('themeVariation')}/dist/img/user3-128x128.jpg"/>
                                        ...
                                        <li>
                                            <a href="#">
                                                <asset:image class="contacts-list-img" src="/${session.getAttribute('themeVariation')}/dist/img/user5-128x128.jpg"/>
                                        ...
                                        <li>
                                            <a href="#">
                                                <asset:image class="contacts-list-img" src="/${session.getAttribute('themeVariation')}/dist/img/user6-128x128.jpg"/>
                                        ...
                                        <li>
                                            <a href="#">
                                                <asset:image class="contacts-list-img" src="/${session.getAttribute('themeVariation')}/dist/img/user8-128x128.jpg"/>
